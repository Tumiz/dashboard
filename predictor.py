...
d = pandas.read_csv("dashboard_monthly.csv", index_col="month").dropna()
...
print(train_set.index[0], len(train_set))
...
model.summary()
early_stopping = keras.callbacks.EarlyStopping(min_delta=10,
                                               monitor="val_loss", 
                                               patience=20, 
